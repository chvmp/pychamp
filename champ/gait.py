...
SECONDS_TO_MILLIS = 1000.0

class TDEvent(object):
    def __init__(self, base, stance_duration=0.25, swing_duration=0.25):
        self._swing_phase_period = swing_duration * SECONDS_TO_MILLIS
        self._stance_phase_period = stance_duration  * SECONDS_TO_MILLIS
        self._stride_period = self._stance_phase_period + self._swing_phase_period
        
        self._elapsed_time_ref = 0.0
        self._last_touch_down = 0.0
